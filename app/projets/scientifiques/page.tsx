      ...
      <main className="pt-16 min-h-screen bg-card-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-card-2 to-card-1 py-16 sm:py-24">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-text mb-6">Projets Scientifiques</h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              <div className="bg-card-2 border border-darkGray rounded-xl p-4 text-center">
                <div className="text-3xl font-bold text-primary mb-1">3</div>
                <div className="text-sm text-text/60">Projets</div>
              </div>
              <div className="bg-card-2 border border-darkGray rounded-xl p-4 text-center">
                <div className="text-3xl font-bold text-secondary mb-1">5</div>
                <div className="text-sm text-text/60">Publications</div>
              </div>
              <div className="bg-card-2 border border-darkGray rounded-xl p-4 text-center">
                <div className="text-3xl font-bold text-secondary mb-1">2</div>
                <div className="text-sm text-text/60">En cours</div>
              </div>
              <div className="bg-card-2 border border-darkGray rounded-xl p-4 text-center">
                <div className="text-3xl font-bold text-text mb-1">10+</div>
                <div className="text-sm text-text/60">Collaborateurs</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-text mb-12 text-center">Projets de Recherche Actifs</h2>
            
            <div className="space-y-8">
              {/* AI for Agriculture */}
              <div className="bg-gradient-to-br from-card-2 to-card-2 border border-primary/30 rounded-xl p-6 sm:p-8">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 bg-darkBlue rounded-xl flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                      <div>
                        <h3 className="text-2xl font-bold text-text mb-2">Intelligence Artificielle pour l'Agriculture</h3>
                    ...
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-text mb-3">Objectifs de recherche :</h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Détection automatique des maladies du café</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Prédiction des rendements agricoles</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Application mobile pour agriculteurs</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Dataset de 10K+ images annotées</span>
                        </div>
                      </div>
                    </div>

                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">TensorFlow</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">Computer Vision</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">Python</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">React Native</span>
                    </div>

                    <div className="bg-card-2 border border-darkGray rounded-lg p-4">
                      <div className="text-sm font-semibold text-text mb-2">Avancement : 60%</div>
                      <div className="w-full bg-card-1 rounded-full h-2 mb-2">
                        <div className="bg-primary h-2 rounded-full" style={{ width: '60%' }}></div>
                      </div>
                      <div className="text-xs text-text/60">Publication prévue : Q4 2024</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-card-2 to-card-2 border border-secondary/30 rounded-xl p-6 sm:p-8">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 bg-darkBlue rounded-xl flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                      <div>
                        <h3 className="text-2xl font-bold text-text mb-2">Blockchain pour la Traçabilité Agricole</h3>
                        <div className="flex items-center gap-2 text-sm text-text/60 mb-2">
                          <Calendar className="w-4 h-4" />
                          <span>2023 - 2024</span>
                        </div>
                    ...
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-text mb-3">Résultats obtenus :</h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Prototype fonctionnel sur Ethereum</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Smart contracts pour transactions</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Interface web pour stakeholders</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                          <span className="text-sm text-text/70">Publication dans journal académique</span>
                        </div>
                      </div>
                    </div>

                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">Ethereum</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">Solidity</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">Web3.js</span>
                      <span className="px-3 py-1 bg-card-2 text-text/70 text-xs rounded-[5px]">React</span>
                    </div>
        ...
        <section className="py-16 bg-gradient-to-b from-transparent via-card-2/20 to-transparent">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-text mb-12 text-center">Publications Scientifiques</h2>
            
            <div className="space-y-6">
              <div className="bg-card-2 border border-darkGray rounded-xl p-6 hover:border-primary/30 transition-all">
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6 hover:border-secondary/30 transition-all">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-darkBlue rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-text mb-12 text-center">Domaines de Recherche</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">Intelligence Artificielle</h3>
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">Blockchain & Web3</h3>
                <p className="text-sm text-text/70 leading-relaxed">
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">Systèmes Distribués</h3>
                <p className="text-sm text-text/70 leading-relaxed">
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">Fintech & Inclusion</h3>
                <p className="text-sm text-text/70 leading-relaxed">
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">E-Government</h3>
                <p className="text-sm text-text/70 leading-relaxed">
              ...
              <div className="bg-card-2 border border-darkGray rounded-xl p-6">
                ...
                <h3 className="text-lg font-bold text-text mb-3">IoT & Agriculture</h3>
                <p className="text-sm text-text/70 leading-relaxed">
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-card-2 to-card-2 border border-secondary/30 rounded-xl p-8 sm:p-12 text-center">
              <div className="w-16 h-16 bg-darkBlue rounded-full flex items-center justify-center mx-auto mb-6">
                <Users className="w-8 h-8 text-secondary" />
              </div>
              <h3 className="text-2xl sm:text-3xl font-bold text-text mb-4">Collaboration Scientifique</h3>
