              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-card-2 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <a href="mailto:Jeanluckashindi812@gmail.com" className="flex items-start gap-4 p-4 bg-darkBlue rounded-lg hover:bg-card-2 transition-all group">
                      <div className="w-10 h-10 bg-darkBlue rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    ...
                    <a href="tel:+25764397262" className="flex items-start gap-4 p-4 bg-darkBlue rounded-lg hover:bg-card-2 transition-all group">
                      <div className="w-10 h-10 bg-darkBlue rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    ...
                    <div className="flex items-start gap-4 p-4 bg-darkBlue rounded-lg">
                ...
                <div className="bg-card-2 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    <a 
                      ...
                      className="flex items-center gap-3 p-3 bg-darkBlue rounded-lg hover:bg-card-2 transition-all group"
                    >
                ...
                <div className="bg-card-2 border border-white/10 rounded-xl p-6 sm:p-8">
                  ...
                  {isSubmitted ? (
                    <div className="flex flex-col items-center justify-center py-12">
                      <div className="w-16 h-16 bg-darkBlue rounded-full flex items-center justify-center mb-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full px-4 py-3 bg-darkBlue border border-darkGray rounded-lg text-text placeholder-text/40 focus:outline-none focus:border-primary/50 transition-colors"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows={6}
                          className="w-full px-4 py-3 bg-darkBlue border border-darkGray rounded-lg text-text placeholder-text/40 focus:outline-none focus:border-primary/50 transition-colors resize-none"
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-primary text-background px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                      >
                        {isSubmitting ? (
                          <>
