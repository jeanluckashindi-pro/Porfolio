        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-card-2 to-card-1 py-16 sm:py-24">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-text mb-6">Mon Histoire</h1>
            ...
            <div className="space-y-12">
              ...
              <div className="relative pl-8 border-l-2 border-primary/30">
                ...
                <div className="mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">La Passion pour la Technologie</h2>
                </div>
              ...
              <div className="relative pl-8 border-l-2 border-secondary/30">
                ...
                <div className="mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">Formation Académique & Premiers Projets</h2>
                </div>
                <p className="text-text/70 leading-relaxed mb-4">
                ...
                <div className="bg-card-2 border border-darkGray rounded-lg p-4 mb-4">
                  <h3 className="text-text font-semibold mb-2">Compétences développées :</h3>
              ...
              <div className="relative pl-8 border-l-2 border-secondary/30">
                ...
                <div className="mb-4">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-card-2 border border-secondary/40 rounded-[5px] mb-2">
                    ...
                    <span className="text-xs text-secondary font-semibold">Premières missions</span>
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">Entrée dans le Monde Professionnel</h2>
                </div>
                <p className="text-text/70 leading-relaxed mb-4">
              ...
              <div className="relative pl-8 border-l-2 border-primary/30">
                ...
                <div className="mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">Mediabox Burundi : L'Impact à Grande Échelle</h2>
                </div>
                <p className="text-text/70 leading-relaxed mb-4">
              ...
              <div className="relative pl-8 border-l-2 border-secondary/30">
                ...
                <div className="mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">UNICEF : Standards Internationaux</h2>
                </div>
                <p className="text-text/70 leading-relaxed mb-4">
              ...
              <div className="relative pl-8">
                <div className="absolute left-0 top-0 w-4 h-4 bg-primary rounded-full -translate-x-[9px] ring-4 ring-card-1"></div>
                <div className="mb-4">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-card-2 border border-darkGray rounded-[5px] mb-2">
                    <Rocket className="w-3 h-3 text-text" />
                    <span className="text-xs text-text font-semibold">Aujourd'hui</span>
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">Continuer à Innover</h2>
                </div>
                <p className="text-text/70 leading-relaxed mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link 
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-primary text-background px-6 py-3 rounded-lg font-semibold hover:bg-darkBlue transition-all text-sm"
                  >
                    Voir mes projets
                  </Link>
                  <Link 
                    href="/contact" 
                    className="inline-flex items-center justify-center gap-2 bg-card-2 text-text px-6 py-3 rounded-lg font-semibold border border-darkGray hover:bg-darkBlue transition-all text-sm"
                  >
                    Me contacter
                  </Link>
                </div>
